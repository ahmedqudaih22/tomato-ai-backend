...
const defaultSettings = {
    ...
    store: {
        packages: [
            { points: 100, price_display: "$5", paymentLink: "" },
            { points: 550, price_display: "$25", paymentLink: "" },
        ]
    },
    announcement: {
        enabled: false,
...
app.listen(port, () => {
    console.log(`✅ SUCCESS: Tomato AI Server v2.2 (Payment Links) is running on port ${port} ✅`);
